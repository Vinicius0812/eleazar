...
import { priorityOrder } from "./services/mock-client.js";
const priorities = { high: "Alta", normal: "Normal", low: "Baixa" };
const statuses = {
  queued: "Na fila",
  running: "Em execução",
      ...
      <div className="content">
        ...
        <main id="main">
          ...
          <div className="announcement">
            <ShieldCheck size={17} />
            <span>
              <strong>Ambiente local de demonstração.</strong> Alterações ficam
              em memória e são restauradas ao recarregar.
            </span>
          </div>
                          ...
                          <article className="run-card" key={run.id}>
                            <div className="run-top">
                              ...
                              <span className="provider-tag">
                                {data.providers.find(
                                  (provider) => provider.id === run.providerId,
                                )?.name ?? run.providerId}
                              </span>
                            </div>
                ...
                <div className="secondary-column">
                  ...
                  >
                    <div className="provider-list">
                      {data.providers.map((provider) => (
                        <div className="provider-row" key={provider.id}>
                          ...
                          <span
                            className={`dot ${provider.status === "available" ? "green" : provider.status === "degraded" ? "orange" : "gray"}`}
                            aria-label={
                    ...
                    <div className="provider-note">
                      Disponibilidade ilustrativa. Nenhum provedor é consultado.
                    </div>
                  </Panel>
                  <Panel
                    id="approvals"
        ...
        >
          ...
          {dialog.kind === "project" && (
            <form onSubmit={submitProject}>
              <p className="form-intro">
                Informe o diretório do projeto. O cadastro demonstrativo não
                acessa nem modifica os arquivos.
              </p>
              <label>
                Nome do projeto
                <input
              ...
              <label>
                ...
                />
                <small>
                  Windows, macOS ou Linux. O caminho não será verificado no
                  disco.
                </small>
              </label>
          ...
          {dialog.kind === "task" && (
            <form onSubmit={submitTask}>
              <p className="form-intro">
                Defina o próximo trabalho. A tarefa entra na fila; nenhuma
                execução será iniciada nesta demonstração.
              </p>
              <label>
                Projeto
                <select
          ...
          {dialog.kind === "approval" && (
            <div className="approval-detail">
              ...
              <p className="form-intro">
                Aprovar devolve a tarefa à fila. Rejeitar marca a tarefa como
                bloqueada. A integração futura será responsável por aplicar a
                decisão.
              </p>
              <div className="form-actions">
                <button
                  ...
                  onClick={() =>
                    void mutate(
                      ...
                      "Proposta rejeitada. A tarefa foi bloqueada na simulação.",
                    )
                  }
                >
                  <X size={16} />
                ...
                <button
                  ...
                  onClick={() =>
                    void mutate(
                      ...
                      "Proposta aprovada. A tarefa voltou à fila na simulação.",
                    )
                  }
                >
                  <Check size={16} />
