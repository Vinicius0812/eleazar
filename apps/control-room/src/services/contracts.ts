...
export interface Task { id: string; projectId: string; title: string; prompt: string; priority: Priority; status: TaskStatus; kind: string; worktreePath: string | null; createdAt: string; updatedAt: string; }
...
export interface RegisterProjectInput { name: string; path: string; }
export interface CreateTaskInput { projectId: string; title: string; prompt: string; priority: Priority; }
